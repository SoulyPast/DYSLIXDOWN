...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <svg class="ghost text-center" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <!-- Content -->
        <h5 class="font-weight-bold text-uppercase mb-4">DYSLIXDOWN</h5>
        <h5>És una app web per millora les habilitats de
            lectoescriptura de tots els nens amb i sense dislèxia.</h5>
      ...
      <div class="col-md-2 col-lg-2 mx-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <!-- Links -->
        <h5 class="font-weight-bold text-uppercase mb-4">Termes I Privacitat</h5>

        <ul class="list-unstyled">
          <li>
            <p>
              <a href="{{url('/privacitat')}}">Privacitat</a>
            </p>
          </li>
          <li>
            <p>
              <a href="{{url('/termes')}}">Termes</a>
            </p>
          </li>
        </ul>
      ...
      <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <ul class="list-unstyled">
          <li>
            <p>
              <i class="fas fa-home mr-3" style='color:#98BEF5'></i> Carrer Pelai Martínez, 1, 17600 Figueres, Girona</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <i class="fas fa-phone mr-3" style='color:#98BEF5'></i> + 972 50 79 08</p>
          </li>
        </ul>
      ...
      <div class="col-md-2 col-lg-2 text-center mx-auto my-4">
        ...
        <a type="button" class="btn-floating btn-fb"  href='https://www.facebook.com/'>
          <i  class="fab fa-facebook-f pr-2" style='font-size:24px;color:#98BEF5'></i>
        </a>
        <!-- Twitter -->
        <a type="button" class="btn-floating btn-tw" href='https://twitter.com/'>
          <i class="fab fa-twitter pr-2" style='font-size:24px;color:#98BEF5'></i>
        </a>
        <!-- Google +-->
        <a type="button" class="btn-floating btn-gplus" href='https://mail.google.com/'>
          <i class="fab fa-google-plus-g pr-2" style='font-size:24px;color:#98BEF5'></i>
        </a>
      </div>
      <!-- Grid column -->
