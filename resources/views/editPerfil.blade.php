...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><h1>{{ __('Edita Perfil') }}</h1></div>

                <div class="card-body">
                    <form method="POST" action="{{  url('editPerfil') }}">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Posa la Teva Contrasenya') }}</label>
